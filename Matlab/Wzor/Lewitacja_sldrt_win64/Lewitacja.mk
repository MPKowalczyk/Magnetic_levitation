...
MODEL                := Lewitacja
MODULES              := Lewitacja_data.c rtGetInf.c rtGetNaN.c rt_look.c rt_look1d.c rt_matrx.c rt_nonfinite.c rt_printf.c 
MAKEFILE             := Lewitacja.mk
...
#
MODELLIB                  := Lewitacjalib_sldrt.lib
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := Lewitacja_ref.rsp
MODELREF_INC_PATH         := 
...
# additional includes
REQ_INCLUDES += ;E:/LP2017/RODA10~1/Wzor/Lewitacja_sldrt_win64;E:/LP2017/RODA10~1/Wzor;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
