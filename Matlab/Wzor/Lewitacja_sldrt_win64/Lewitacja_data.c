...
P_Lewitacja_T Lewitacja_P = {
  0.0,                                 /* Mask Parameter: Controller_D
                                        * Referenced by: '<S1>/Kd'
                                        */
  100.0,                               /* Mask Parameter: Controller_I
                                        * Referenced by: '<S1>/Ki'
                                        */
  100.0,                               /* Mask Parameter: Controller_P
                                        * Referenced by: '<S1>/Kp'
                                        */
  0.001,                               /* Mask Parameter: MagneticLevitationSystem_T0
                                        * Referenced by: '<S2>/1//T0'
                                        */
  0.001,                               /* Mask Parameter: Controller_T0
                                        * Referenced by: '<S1>/Kd'
                                        */
