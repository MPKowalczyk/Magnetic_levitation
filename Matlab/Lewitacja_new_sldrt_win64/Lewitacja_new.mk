...
MODEL                := Lewitacja_new
MODULES              := Lewitacja_new_data.c rtGetInf.c rtGetNaN.c rt_look.c rt_look1d.c rt_matrx.c rt_nonfinite.c rt_printf.c 
MAKEFILE             := Lewitacja_new.mk
MATLAB_ROOT          := C:/PROGRA~1/MATLAB/R2015A~1
MATLAB_BIN           := C:/PROGRA~1/MATLAB/R2015A~1/bin
S_FUNCTIONS          := ML_AnalogInputs.c ML_PWM.c
S_FUNCTIONS_LIB      := 
SOLVER               := 
NUMST                := 2
TID01EQ              := 1
...
#
MODELLIB                  := Lewitacja_newlib_sldrt.lib
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := Lewitacja_new_ref.rsp
MODELREF_INC_PATH         := 
...
# additional includes
REQ_INCLUDES += ;E:/LP2017/RODA10~1/Lewitacja_new_sldrt_win64;E:/LP2017/RODA10~1;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
...
%.obj : $(MATLAB_ROOT)/toolbox/MagLev/devdriv/%.c $(MAKEFILE)
	$(call BUILDOBJ, $(CC))
...
%.obj : $(MATLAB_ROOT)/toolbox/MagLev/devdriv/%.cpp $(MAKEFILE)
	$(call BUILDOBJ, $(CPP))
